...
class ControllerShowcaseCreatePdf extends Controller {
    constructor(request, response) {
        super(request, response);
        
        // BASE VALUES FOR QUARTER REPORT
        this.reportIdCode = "2018-Q4";
    }
    ...
    action_processForm() {
        ...
        const pdfPathAndFileName = 'output/showcaseCreatePdfTest.pdf';
        ...
        pdfDoc.pipe(fs.createWriteStream('public/' + pdfPathAndFileName)).on('finish', function () {
            ...
            that.formMessage = `View the generated PDF <a target="_blank" href="${pdfPathAndFileName}">here</a>.`;

            that.sendResponse();
        });
        //pdfDoc.pipe(fs.createWriteStream('public/' + pdfPathAndFileName));
        pdfDoc.end();
        ...
        /*
        const lorem = qsys.getLoremIpsumText(11);

        const doc = new PDFDocument({
            margin: 35
        });
        doc.pipe(fs.createWriteStream('public/' + pdfPathAndFileName));
...
module.exports = ControllerShowcaseCreatePdf