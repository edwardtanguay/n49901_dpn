...
class ControllerShowcaseFormAndAjaxControls extends Controller {
    ...
    action_loadPageData() {
        ...
        dpDataLoader.getRecordWithSql('showcaseBooks', 'SELECT * FROM showcaseBooks WHERE id = 342');
        const that = this;
            ...
            that.responseData = {
                fields: {
                    ...
                    kind: {
                        ...
                        errorMessage: '',
                        displayStatus: 'show',
                        choicesList: 'Paperback| Hardcover| E-Book[ebook]| PDF[pdf]',
                    ...
                    section: {
                        ...
                        choiceSelector: 'radioHorizontal'
                    }
                }
            };
            that.prepareFields();
...
module.exports = ControllerShowcaseFormAndAjaxControls