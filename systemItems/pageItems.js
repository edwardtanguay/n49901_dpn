...
class PageItems extends Items {
	...
	getItemTypeDefinitionBlock() {
		...
		*Access Groups;list;$info=This controls access to a page, e.g. if a user logs in and has "developers,administrators" in their accessCodes, then they will be able to see all pages with either "developers" or "administrators" in the page's accessCodes field. For pages that should be available to anyone, enter "loggedInUsers,loggedOutUsers".
